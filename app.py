...
class LoginApp:
    def __init__(self, root):
        ...
        self.db_produtos = DatabaseProdutos()  # Instância de DatabaseProdutos aqui
    ...
    def login(self):
        ...
        if self.db_contas.verificarLogin(username, password):
            ...
            ProdutoApp(self.root, self.db_produtos)  # Abre a tela de produtos
        else:
            messagebox.showerror("Erro de Login", "Usuário ou senha incorretos.")

    def abrirTelaCadastro(self):
        # Tela de Cadastro encapsulada em função
...
class ProdutoApp:
    def __init__(self, root, db_produtos):
        ...
        # Cria a janela de produtos como uma nova janela Toplevel
        ...
        # Define o evento de fechamento para voltar ao login somente quando o usuário fecha a janela
        self.produtos_window.protocol("WM_DELETE_WINDOW", self.voltarTelaLogin)

        # Label e Listbox para exibir produtos
        ...
        # Botões para adicionar, alterar e excluir produtos
    ...
    def voltarTelaLogin(self):
        ...
        self.root.deiconify()  # Mostra novamente a janela de login ao fechar a de produtos
